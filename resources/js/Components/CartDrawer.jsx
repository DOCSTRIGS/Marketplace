...
export default function CartDrawer({ isOpen, onClose }) {
    ...
    return (
        <>
            ...
            {/* Drawer */}
            <div className={`fixed right-0 top-0 h-full w-full max-w-md bg-white z-[101] shadow-2xl transform transition-transform duration-500 ease-in-out ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
