    ...
    return (
        <SellerLayout>
            ...
            <div className="max-w-4xl mx-auto py-12">
                <div className="bg-white dark:bg-[#1e1e1e] rounded-[40px] shadow-2xl shadow-[#8B4513]/5 p-12 text-center border border-gray-100 dark:border-gray-800 relative overflow-hidden transition-colors">
                    {/* Decorative elements */}
                    ...
                    <p className="text-xl text-gray-500 dark:text-gray-400 font-medium leading-relaxed mb-10 max-w-2xl mx-auto">
                    ...
                    <div className="inline-block mb-10">
                        <span className="text-sm font-black uppercase tracking-widest text-orange-500 dark:text-orange-400 bg-orange-50 dark:bg-orange-900/20 px-6 py-3 rounded-full border border-orange-100 dark:border-orange-900/40">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 text-left mb-10">
                        <div className="p-6 bg-gray-50 dark:bg-white/5 rounded-3xl border border-gray-100 dark:border-gray-800">
                            <p className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-2">Pourquoi cette attente ?</p>
                            <p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed font-medium">
                                Nous vérifions chaque vendeur pour assurer une expérience premium. Cela prend généralement moins de 24h.
                            </p>
                        </div>
                        <div className="p-6 bg-gray-50 dark:bg-white/5 rounded-3xl border border-gray-100 dark:border-gray-800">
                            <p className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-2">Prochaines étapes</p>
                            <p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed font-medium">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        ...
                        <button className="w-full sm:w-auto px-8 py-4 bg-white dark:bg-transparent text-gray-600 dark:text-gray-300 font-black rounded-2xl border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-white/5 transition-all uppercase tracking-widest text-xs">
                ...
                <div className="mt-12 flex items-center justify-center gap-8">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest">Serveur Opérationnel</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <div className="w-2 h-2 rounded-full bg-[#8B4513]"></div>
                        <span className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest">Sécurisé par LoméPay</span>
                    </div>
                </div>
            </div>
        </SellerLayout>
