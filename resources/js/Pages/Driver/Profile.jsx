                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                                    <div className="space-y-3">
                                        ...
                                        <div className="relative h-40 bg-gray-50 dark:bg-[#121212] rounded-3xl border-2 border-dashed border-gray-200 dark:border-gray-850 flex items-center justify-center overflow-hidden">
                                            {user.vehicle_image ? (
                                                <img src={user.vehicle_image_url} loading="lazy" decoding="async" className="w-full h-full object-cover opacity-50" />
                                            ) : null}
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="relative h-40 bg-gray-50 dark:bg-[#121212] rounded-3xl border-2 border-dashed border-gray-200 dark:border-gray-850 flex items-center justify-center overflow-hidden">
                                            {user.license_image ? (
                                                <img src={user.license_image_url} loading="lazy" decoding="async" className="w-full h-full object-cover opacity-50" />
                                            ) : null}
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="relative h-40 bg-gray-50 dark:bg-[#121212] rounded-3xl border-2 border-dashed border-gray-200 dark:border-gray-850 flex items-center justify-center overflow-hidden">
                                            {user.insurance_image ? (
                                                <img src={user.insurance_image_url} loading="lazy" decoding="async" className="w-full h-full object-cover opacity-50" />
                                            ) : null}
